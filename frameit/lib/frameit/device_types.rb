...
module Frameit
  ...
  module Devices
    ...
    IPHONE_15 ||= Frameit::Device.new("iphone-15", "Apple iPhone 15", 12, [[1170, 2532], [2532, 1170]], 460, Color::MIDNIGHT, Platform::IOS)
    IPHONE_15_PLUS ||= Frameit::Device.new("iphone-15-plus", "Apple iPhone 15 Plus", 12, [[1284, 2778], [2778, 1284]], 458, Color::MIDNIGHT, Platform::IOS)
    IPHONE_15_PRO ||= Frameit::Device.new("iphone-15-pro", "Apple iPhone 15 Pro", 12, [[1178, 2556], [2556, 1178]], 460, Color::PURPLE, Platform::IOS)
    IPHONE_15_PRO_MAX ||= Frameit::Device.new("iphone15-pro-max", "Apple iPhone 15 Pro Max", 12, [[1290, 2796], [2796, 1290]], 458, Color::PURPLE, Platform::IOS)
